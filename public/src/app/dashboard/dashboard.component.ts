...
export class DashboardComponent implements OnInit {
    ...
    // This function runs when the search button is hit and then filters
    // our polls variable based on the search and the polls which match are then kept in displaypolls
}
